...
datafile <- read.csv("raw-data/Trockur_Saarl_2018_1.csv",as.is=T)

source('~/winhome/dbowler/sMon-insects/R/sparta_wrapper_functions.R')
...
#Jagend# all good
#Ruhe# all good
datafile$Adult <- apply(datafile[,c("Adulte","Jagdflug","Jagend","Ruhe")],1,sum,na.rm=T)
