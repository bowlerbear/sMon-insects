...
generated quantities {
  ...
  vector[complete_N] psi = inv_logit(Intercept + rep_vector(0.0, complete_N) + complete_Xs * bs + complete_Zs_1_1 * s_1_1 + complete_Zs_1_2 * s_1_2 + complete_Zs_1_3 * s_1_3 + complete_Zs_1_4 * s_1_4 + complete_Zs_1_5 * s_1_5 + complete_Zs_1_6 * s_1_6 + complete_Zs_1_7 * s_1_7);
