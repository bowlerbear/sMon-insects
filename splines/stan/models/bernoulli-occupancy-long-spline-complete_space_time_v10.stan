data {
  ...
  matrix[n_site, knots_1[4]] Zs_1_4;
  matrix[n_site, knots_1[5]] Zs_1_5;
  matrix[n_site, knots_1[6]] Zs_1_6;
  matrix[n_site, knots_1[7]] Zs_1_7;
  ...
  matrix[complete_N, complete_knots_1[4]] complete_Zs_1_4;
  matrix[complete_N, complete_knots_1[5]] complete_Zs_1_5;
  matrix[complete_N, complete_knots_1[6]] complete_Zs_1_6;
  matrix[complete_N, complete_knots_1[7]] complete_Zs_1_7;
}
parameters {
  ...
  real<lower=0> sds_1_4;  // standard deviations of spline coefficients
  real<lower=0> sds_1_5;  // standard deviations of spline coefficients
  real<lower=0> sds_1_6;  // standard deviations of spline coefficients
  real<lower=0> sds_1_7;  // standard deviations of spline coefficients
}
transformed parameters {
  ...
  vector[knots_1[4]] s_1_4;
  vector[knots_1[5]] s_1_5;
  vector[knots_1[6]] s_1_6;
  vector[knots_1[7]] s_1_7;
  s_1_1 = sds_1_1 * zs_1_1;
  s_1_2 = sds_1_2 * zs_1_2;
  s_1_3 = sds_1_3 * zs_1_3;
  s_1_4 = sds_1_4 * zs_1_4;
  s_1_5 = sds_1_5 * zs_1_5;
  s_1_6 = sds_1_6 * zs_1_6;
  s_1_7 = sds_1_7 * zs_1_7;
}
model {
  
  //occupancy model linear predictor
  vector[n_site] logit_psi = Intercept + rep_vector(0.0, n_site) + Xs * bs + Zs_1_1 * s_1_1 + Zs_1_2 * s_1_2 + Zs_1_3 * s_1_3 + Zs_1_4 * s_1_4 + Zs_1_5 * s_1_5 + Zs_1_6 * s_1_6 + Zs_1_7 * s_1_7;
  ...
  target += student_t_lpdf(sds_1_3 | 3, 0, 2.5)
    - 1 * student_t_lccdf(0 | 3, 0, 2.5);
  target += student_t_lpdf(sds_1_4 | 3, 0, 2.5)
    - 1 * student_t_lccdf(0 | 3, 0, 2.5);
  target += student_t_lpdf(sds_1_5 | 3, 0, 2.5)
    - 1 * student_t_lccdf(0 | 3, 0, 2.5);
  target += student_t_lpdf(sds_1_6 | 3, 0, 2.5)
    - 1 * student_t_lccdf(0 | 3, 0, 2.5);
  target += student_t_lpdf(sds_1_7 | 3, 0, 2.5)
    - 1 * student_t_lccdf(0 | 3, 0, 2.5);
  target += std_normal_lpdf(zs_1_1);
  target += std_normal_lpdf(zs_1_2);
  target += std_normal_lpdf(zs_1_3);
  target += std_normal_lpdf(zs_1_4);
  target += std_normal_lpdf(zs_1_5);
  target += std_normal_lpdf(zs_1_6);
  target += std_normal_lpdf(zs_1_7);
...
generated quantities {
  ...
  vector[complete_N] psi = bernoulli_rng(inv_logit(Intercept + rep_vector(0.0, complete_N) + complete_Xs * bs + complete_Zs_1_1 * s_1_1 + complete_Zs_1_2 * s_1_2 + complete_Zs_1_3 * s_1_3 + complete_Zs_1_4 * s_1_4 + complete_Zs_1_5 * s_1_5 + complete_Zs_1_6 * s_1_6 + complete_Zs_1_7 * s_1_7));
