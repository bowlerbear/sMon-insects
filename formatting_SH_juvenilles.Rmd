...
datafile <- read.csv("raw-data/Libellen_Schleswig-Holstein.csv",as.is=T)
...
#only one lat lon per grid  -  basically the centroid
...
save(juv_datafile,file="derived-data/juv_datafile_SH.RData")
