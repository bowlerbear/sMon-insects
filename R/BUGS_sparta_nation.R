cat("
  model{
  # JAGS code for trends
  #https://nwfsc-timeseries.github.io/atsa-labs/sec-jags-ar1.html
  ...
  for(j in 1:nvisit) {
    ...
    #box year effects
    for (i in 1:nbox){ 
        box.a.effect[i] ~ dnorm(a.effect, tau.box.a)
    }
    a.effect ~ dnorm(0,0.01)
    tau.box.a <- 1/(sd.box.a * sd.box.a) 
    sd.box.a ~ dt(0, 1, 1)T(0,) 
    ...
    ",fill=TRUE,file="R/BUGS_sparta_nation.txt")