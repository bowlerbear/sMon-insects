...
Each row is the data frame is a species observation.
...
(Note: the data file does also count information on counts, but for the moment we only use information on species presence)
...
#in sparta wrapper functions
plotPredictions(myAnnualPredictions,df)
