...
datafile <- read.csv("raw-data/rohdaten_aklnrw_an_idiv_181116/data-1542363531429.csv",as.is=T)
...
```{r}
speciesDF <- read.csv("raw-data/rohdaten_aklnrw_an_idiv_181116/reflibellenarten.csv",as.is=T)
...
```{r}
geoDF <- read.csv("raw-data/rohdaten_aklnrw_an_idiv_181116/reffundortart.csv",as.is=T)
