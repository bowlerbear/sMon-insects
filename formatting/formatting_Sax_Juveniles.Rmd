...
datafile <- readOGR(dsn="C:/Users/db40fysa/Nextcloud/sMon-Analyses/Git/sMon-insects/raw-data/Saxony/Libellen", layer="20181122-ZeNA-Libellen-3")
...
datafile <- subset(datafile,Einheit %in%c("Emergenz","Exuvien","Jungtier","Larve","Puppe"))
...
names(juv_datafile)[which(names(juv_datafile)=="Anzahl")] <- "Anzahl_min"
save(juv_datafile,file="derived-data/juv_datafile_Sax.RData")
saveRDS(juv_datafile,file="derived-data/juv_datafile_Sax.rds")
