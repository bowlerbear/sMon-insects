...
library(rgdal)
datafile <- read.csv("C:/Users/db40fysa/Nextcloud/sMon-Analyses/Odonata_Git/sMon-insects/raw-data/MV/qry_ArtData.csv",sep=";",dec=",",as.is=T)
...
```{r}
einheitDF <- read.csv("C:/Users/db40fysa/Nextcloud/sMon-Analyses/Git/sMon-insects/raw-data/MV/dbo_tblEinheiten.csv",sep=",",dec=",",as.is=T)
...
datafile <- subset(datafile,!Einheit %in% c("Jungtier","Larve"))
...
beobachterDF <- read.csv("C:/Users/db40fysa/Nextcloud/sMon-Analyses/Git/sMon-insects/raw-data/MV/dbo_vwBeobachter.csv",sep=",",as.is=T)
