...
library(rgdal)
datafile <- readOGR(dsn="C:/Users/db40fysa/Nextcloud/sMon-Analyses/Odonata_Git/sMon-insects/raw-data/Thuringia/dragonflies_TH",layer="dragonflies_TH")
...
datafile <- subset(datafile,STATUS_K_R %in% c("Im","k","e","If","MI","WI","?","Ex"))
